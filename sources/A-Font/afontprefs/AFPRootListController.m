...
#include "AFPFontListController.h"
#import <spawn.h>
...
- (NSArray *)specifiers {
	if (!_specifiers) {
		...
		// 	specifier;
		// })];
		PSSpecifier *_fontSpecifier = [PSSpecifier preferenceSpecifierNamed:LocalizeString(@"Font") target:self set:@selector(setFont:forSpecifier:) get:@selector(getFont:) detail:[AFPFontListController class] cell:PSLinkListCell edit:nil];
		...
		PSSpecifier *_boldFontSpecifier = [PSSpecifier preferenceSpecifierNamed:LocalizeString(@"Bold Font") target:self set:@selector(setFont:forSpecifier:) get:@selector(getFont:) detail:[AFPFontListController class] cell:PSLinkListCell edit:nil];
